...
<section class="header-single">
    <div class="container">
        <div class="row">
            <div class="col-md-8 d-flex align-items-center int">
                <div class="inner">
                    ...
                    <?php if (have_rows('intro_opleiding')) : ?>
                        <?php while (have_rows('intro_opleiding')) : the_row(); ?>
...
<?php if (have_rows('content_opleiding')) : ?>
    <section class="sngl-cnt">
        <?php while (have_rows('content_opleiding')) : the_row(); ?>
            <?php if (get_row_layout() == 'volledige_tekst') : ?>
            ...
            <?php elseif (get_row_layout() == 'afbeelding_volledig') : ?>
                <?php $afbeelding = get_sub_field('afbeelding'); ?>
                <?php if ($afbeelding) { ?>
                    <div class="fllimg" style="background-image:url(<?php echo $afbeelding['sizes']['large']; ?>);"></div>
                <?php } ?>
            <?php endif; ?>
        <?php endwhile; ?>
    </section>
...
<section class="edu sngl-edu">
    <div class="container">
        <div class="row">
            <div class="col-md-12 int">
                <h2><?php _e('Gerelateerde opleidingen', 'talentplaats'); ?></h2>
            </div>
            <div class="col-md-12">
