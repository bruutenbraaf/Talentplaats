...
get_header(); ?>
<section class="header-vac" style="background-image:url(<?php echo get_the_post_thumbnail_url($post, 'large'); ?>);">
    <div class="inner">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <?php the_field('pagina_titel_vacatures'); ?>
                    <div class="hpsf sngl-hpsf">
                        <div class="sfv">
...
<section class="vacansie-view">
    ...
    <svg class="bg" preserveAspectRatio="none" viewBox="0 0 1051 644" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13 565C119.667 629 384.6 688.2 591 413C797.4 137.8 979.667 39.6667 1045 25" stroke="#FF6600" stroke-width="50" />
    </svg>
</section>

<?php if (get_field('opleidingen_tonen') == 1) { ?>
    <section class="edu vac-edu">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <?php the_field('titel_boven_opleidingen'); ?>
                </div>
                ...
                <?php $alle_opleidingen_knop = get_field('alle_opleidingen_knop'); ?>
...
<?php if (get_field('seo_tekst')) { ?>
    <section class="s">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="int">
                        <?php the_field('seo_tekst'); ?>
                    </div>
                </div>
            </div>
        </div>
