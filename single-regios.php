...
<?php if (have_rows('header_inf')) : ?>
    <?php while (have_rows('header_inf')) : the_row(); ?>
        <section class="header-reg" <?php if (get_the_post_thumbnail_url($post, 'large')) { ?> style="background-image:url(<?php echo get_the_post_thumbnail_url($post, 'large'); ?>" alt="<?php echo $achtergrond_afbeelding['alt']; ?>);" <?php } ?>>
            <div class="container">
                <div class="row">
